...
public class ValidationUtils implements Serializable {
   ...
   *
   * @param expression una expresiÃ³n de tipo boolean
   * @param errorMessage el mensaje de la excepciÃ³n que se utilizarÃ¡ si la verificaciÃ³n falla; el
   *        mensaje se convertirÃ¡ a String utilizando la expresiÃ³n String.valueOf(Object)
   * @throws IllegalArgumentException si la expresiÃ³n es falsa
   */
   ...
   *
   *
   * @param string la cadena que se desea verificar
